!(function(o, s, r) {
  ...
  (r.app.menu = {
    ...
    manualScroller: {
      ...
      update: function() {
        if (this.obj) {
          if (!0 === r(".main-menu").data("scroll-to-active")) {
            var e, n, a;
            if (
              ((e = s.querySelector(".main-menu-content li.active")),
              l.hasClass("menu-collapsed"))
            )
              r(".main-menu-content li.sidebar-group-active").length &&
                (e = s.querySelector(
                  ".main-menu-content li.sidebar-group-active"
                ));
            else if (
              ((n = s.querySelector(".main-menu-content")),
              e && (a = e.getBoundingClientRect().top + n.scrollTop),
              a > parseInt((2 * n.clientHeight) / 3))
            )
              var i = a - n.scrollTop - parseInt(n.clientHeight / 2);
            setTimeout(function() {
              r.app.menu.container.stop().animate({ scrollTop: i }, 300),
                r(".main-menu").data("scroll-to-active", "false");
            }, 300);
          }
          this.obj.update();
        }
      ...
      updateHeight: function() {
        ("vertical-menu" != l.data("menu") &&
          ...
          "vertical-overlay-menu" != l.data("menu")) ||
          !r(".main-menu").hasClass("menu-fixed") ||
          (r(".main-menu-content").css(
            "height",
            r(o).height() -
              r(".header-navbar").height() -
              r(".main-menu-header").outerHeight() -
              r(".main-menu-footer").outerHeight()
          ),
          this.update());
      }
    },
    ...
    drillDownMenu: function(e) {
      r(".drilldown-menu").length &&
        ("sm" == e || "xs" == e
          ? "true" == r("#navbar-mobile").attr("aria-expanded") &&
            r(".drilldown-menu").slidingMenu({ backLabel: !0 })
          : r(".drilldown-menu").slidingMenu({ backLabel: !0 }));
    },
    change: function(e) {
      ...
      ("vertical-menu" !== s && "vertical-menu-modern" !== s) ||
        this.toOverlayMenu(n.name, s),
        l.is(".horizontal-layout") &&
          !l.hasClass(".horizontal-menu-demo") &&
          (this.changeMenu(n.name), r(".menu-toggle").removeClass("is-active")),
        "horizontal-menu" != s && this.drillDownMenu(n.name),
        "xl" == n.name &&
          (r('body[data-open="hover"] .header-navbar .dropdown')
            .on("mouseenter", function() {
              r(this).hasClass("show")
                ? r(this).removeClass("show")
                : r(this).addClass("show");
            })
            .on("mouseleave", function(e) {
              r(this).removeClass("show");
            }),
          r('body[data-open="hover"] .dropdown a').on("click", function(e) {
            if ("horizontal-menu" == s && r(this).hasClass("dropdown-toggle"))
              return !1;
          })),
        r(".header-navbar").hasClass("navbar-brand-center") &&
          r(".header-navbar").attr("data-nav", "brand-center"),
        "sm" == n.name || "xs" == n.name
          ? r(".header-navbar[data-nav=brand-center]").removeClass(
              "navbar-brand-center"
            )
          : r(".header-navbar[data-nav=brand-center]").addClass(
              "navbar-brand-center"
            ),
        "xl" == n.name &&
          "horizontal-menu" == s &&
        ...
        "xl" !== n.name &&
          "horizontal-menu" == s &&
          r("#navbar-type").toggleClass("d-none d-xl-block"),
        r("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) {
          0 < r(this).siblings("ul.dropdown-menu").length && e.preventDefault(),
            e.stopPropagation(),
            r(this)
              .parent()
              .siblings()
        ...
        "horizontal-menu" == s &&
          (r("li.dropdown-submenu").on("mouseenter", function() {
            r(this)
              .parent(".dropdown")
              .hasClass("show") || r(this).removeClass("openLeft");
          ...
          r(".theme-layouts")
            .find(".semi-dark")
            .hide(),
          r("#customizer-navbar-colors").hide()),
          ...
          ((jQuery.expr[":"].Contains = function(e, n, a) {
            return (
              ...
              (e.textContent || e.innerText || "")
                .toUpperCase()
                .indexOf(a[3].toUpperCase())
            );
          }),
          (a = r("#main-menu-navigation")),
          (i = r(".menu-search")),
          r(i)
            .change(function() {
              var e = r(this).val();
      ...
      l.addClass("changing-menu"),
        ...
        l.hasClass("vertical-layout") &&
          (l.hasClass("menu-open") || l.hasClass("menu-expanded")
            ? (r(".menu-toggle").addClass("is-active"),
              "vertical-menu" === l.data("menu") &&
                r(".main-menu-header") &&
                r(".main-menu-header").show())
            : (r(".menu-toggle").removeClass("is-active"),
              "vertical-menu" === l.data("menu") &&
                r(".main-menu-header") &&
                r(".main-menu-header").hide())),
        setTimeout(function() {
      ...
      this.transit(
        function() {
          l.removeClass("menu-hide menu-collapsed").addClass("menu-open"),
            (this.hidden = !1),
            (this.expanded = !0),
            l.hasClass("vertical-overlay-menu") &&
              (r(".sidenav-overlay")
                .removeClass("d-none")
                .addClass("d-block"),
        ...
        function() {
          !r(".main-menu").hasClass("menu-native-scroll") &&
            ...
            l.hasClass("vertical-overlay-menu") ||
              (r(".sidenav-overlay").removeClass("d-block d-none"),
              r("body").css("overflow", "auto"));
        }
      );
    },
    hide: function() {
    ...
    expand: function() {
      !1 === this.expanded &&
        ("vertical-menu-modern" == l.data("menu") &&
          r(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("feather icon-circle")
    ...
    collapse: function(e) {
      !1 === this.collapsed &&
        ("vertical-menu-modern" == l.data("menu") &&
          r(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("feather icon-disc")
            .addClass("feather icon-circle"),
        this.transit(
          function() {
            l.removeClass("menu-expanded").addClass("menu-collapsed"),
              (this.collapsed = !0),
              (this.expanded = !1),
              r(".content-overlay").removeClass("d-block d-none");
          },
          function() {
            "horizontal-menu" == l.data("menu") &&
              l.hasClass("vertical-overlay-menu") &&
              ...
              ("vertical-menu" != l.data("menu") &&
                ...
                r(".main-menu-content").css(
                  "height",
                  r(o).height() - r(".header-navbar").height()
                ),
              "vertical-menu-modern" == l.data("menu") &&
                r(".main-menu").hasClass("menu-fixed") &&
                this.manualScroller.enable();
    ...
    toOverlayMenu: function(e, n) {
      ...
      "vertical-menu-modern" == n
        ? "lg" == e || "md" == e || "sm" == e || "xs" == e
          ...
          : l.hasClass("vertical-overlay-menu") &&
            l.removeClass("vertical-overlay-menu").addClass(a)
        : "sm" == e || "xs" == e
        ? l.hasClass(a) && l.removeClass(a).addClass("vertical-overlay-menu")
        : l.hasClass("vertical-overlay-menu") &&
          l.removeClass("vertical-overlay-menu").addClass(a);
    ...
    changeMenu: function(e) {
      ...
      "xl" === e
        ...
        : (l
          ...
          s.removeClass().addClass("has-sub"),
          r.app.nav.init(),
          r("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) {
            e.preventDefault(),
              e.stopPropagation(),
    ...
    (r.app.nav = {
        ...
        r(".navigation-main")
            ...
            if (
              ...
              if (
                ...
                (i = e.css("border-top")
                  ...
                  : e.position().top),
                "vertical-compact-menu" !== l.data("menu") &&
                  s
                    .appendTo(".main-menu-content")
                    .css({ position: "fixed", top: i }),
          ...
          .on("open.app.menu", "li", function(e) {
            ...
            if (
              (n.addClass("open"),
              t.expand(n),
              r(".main-menu").hasClass("menu-collapsible"))
            )
              return !1;
            n
              .siblings(".open")
          ...
          r(".navbar-header, .main-menu")
            .on("mouseenter", function() {
              if (
                "vertical-menu-modern" == l.data("menu") &&
                (r(".main-menu, .navbar-header").addClass("expanded"),
                l.hasClass("menu-collapsed"))
              ) {
                0 === r(".main-menu li.open").length &&
                  r(".main-menu-content")
                    .find("li.active")
                    .parents("li")
                    .addClass("open");
            ...
            .on("mouseleave", function() {
              l.hasClass("menu-collapsed") &&
                ...
                setTimeout(function() {
                  if (
                    0 === r(".main-menu:hover").length &&
                    0 === r(".navbar-header:hover").length &&
                    (r(".main-menu, .navbar-header").removeClass("expanded"),
                    l.hasClass("menu-collapsed"))
                  ) {
      ...
      adjustSubmenu: function(e) {
        ...
        r(".main-menu-header").height(),
          ...
          (t = 0),
          o.height(),
          0 < parseInt(e.css("border-top"), 10) &&
            (t = parseInt(e.css("border-top"), 10)),
          (s = i - n - e.height() - 30),
          r(".main-menu").hasClass("menu-dark"),
          (a = n + e.height() + t),
          l
            ...
            .appendTo(".main-menu-content")
            .css({ top: a, position: "fixed", "max-height": s });
        ...
        e.children("ul")
          ...
          .slideUp(r.app.nav.config.speed, function() {
            r(this).css("display", ""),
              ...
              n && n(),
              r.app.nav.container.trigger("collapsed.app.menu");
          });
      },
      expand: function(e, n) {
        var a = e.children("ul"),
        ...
        a.hide().slideDown(r.app.nav.config.speed, function() {
          r(this).css("display", ""),
            n && n(),
            r.app.nav.container.trigger("expanded.app.menu");
        }),
          setTimeout(function() {
