!(function(i, r, f) {
  ...
  var c = f("html"),
    ...
    h = "#ea5455";
  if (
    (f(i).on("load", function() {
      var e = !1;
      d.hasClass("menu-collapsed") && (e = !0),
        f("html").data("textdirection"),
        setTimeout(function() {
      ...
      !1 === f.app.nav.initialized && f.app.nav.init({ speed: 300 }),
        ...
        0 < f(".navbar-hide-on-scroll").length &&
          (f(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            classes: {
              initial: "headroom",
        ...
        f(".scrollable-container").each(function() {
          new PerfectScrollbar(f(this)[0], { wheelPropagation: !1 });
        }),
        ...
        f('.card .heading-elements a[data-action="collapse"]').on(
          "click",
          function() {
            var e,
              a = f(this).closest(".card");
      ...
      "horizontal-menu" != a &&
        ...
        f(".heading-elements-toggle").on("click", function() {
          f(this)
      ...
      if (
        (t.css("height", s),
        d.hasClass("boxed-layout") && d.hasClass("vertical-overlay-menu"))
      ) {
        var i = n.width(),
          o = f(".app-content").position().left - i;
        d.hasClass("menu-flipped")
          ? n.css("right", o + "px")
          : n.css("left", o + "px");
      }
        ...
        f(".char-textarea").on("keyup", function(e) {
          !(function(e, a) {
            ...
            (function(e) {
              ...
              (e.value.length < t - 1 && (e.value = e.value.substring(0, t)));
            f(".char-count").html(e.value.length),
              e.value.length > t
                ? (s.css("background-color", h),
                  n.css("color", h),
                  n.addClass("max-limit"))
                : (s.css("background-color", "#7367f0"),
                  n.css("color", "#4e5154"),
                  n.removeClass("max-limit"));
          })(this, e),
            f(this).addClass("active");
        }),
        f(".content-overlay").on("click", function() {
          f(".search-list").removeClass("show"),
            f(".app-content").removeClass("show-overlay"),
            f(".bookmark-wrapper .bookmark-input").removeClass("show");
        });
      ...
      0 < l.length &&
        l[0].addEventListener("ps-scroll-y", function() {
          ...
          f(this)
            .find(".ps__thumb-y")
            .position().top
            ? f(".shadow-bottom").css("display", "block")
            : f(".shadow-bottom").css("display", "none");
        });
    }),
  ...
  f(r).on("click", ".menu-toggle, .modern-nav-toggle", function(e) {
    return (
      ...
      0 < f("#collapse-sidebar-switch").length &&
        setTimeout(function() {
          d.hasClass("menu-expanded") || d.hasClass("menu-open")
            ? f("#collapse-sidebar-switch").prop("checked", !1)
            : f("#collapse-sidebar-switch").prop("checked", !0);
        }, 50),
      f(
    ...
    f(".navigation")
      ...
      .has("ul")
      .addClass("has-sub"),
    f(".carousel").carousel({ interval: 2e3 }),
    ...
    "undefined" != typeof screenfull &&
      screenfull.isEnabled &&
      f(r).on(screenfull.raw.fullscreenchange, function() {
        screenfull.isFullscreen
          ? (f(".nav-link-expand")
              .find("i")
              .toggleClass("icon-minimize icon-maximize"),
            f("html").addClass("full-screen"))
          : (f(".nav-link-expand")
              .find("i")
              .toggleClass("icon-maximize icon-minimize"),
            f("html").removeClass("full-screen"));
      }),
    f(r).ready(function() {
      f(".step-icon").each(function() {
        ...
        0 < e.siblings("span.step").length &&
          ...
          f(this).appendTo(f(this).siblings("span.step")));
      });
    }),
    f(i).resize(function() {
    ...
    f("#sidebar-page-navigation").on("click", "a.nav-link", function(e) {
      ...
      var a = f(this),
        t = a.attr("href"),
        s = f(t).offset().top - 80;
      f("html, body").animate({ scrollTop: s }, 0),
        setTimeout(function() {
          a
            .parent(".nav-item")
            .siblings(".nav-item")
    ...
    f(".dropdown-language .dropdown-item").on("click", function() {
      ...
      f("#dropdown-flag .selected-language").text(a),
        f("#dropdown-flag .flag-icon")
          .removeClass()
          .addClass(t);
  ...
  if (
    (t.on("click", function(e) {
      e.stopPropagation(),
        ...
        g.find("input").blur(),
        g.find("input").focus(),
        n.find(".search-list").addClass("show");
      ...
      for (var s = 0; s < a.length; s++)
        t +=
          ...
          a[s].firstChild.href +
          '><div class="d-flex justify-content-start align-items-center"><span class="mr-75 ' +
          a[s].firstChild.firstChild.className +
          '"  data-icon="' +
          a[s].firstChild.firstChild.className +
          '"></span><span>' +
          a[s].firstChild.dataset.originalTitle +
          '</span></div><span class="float-right bookmark-icon feather icon-star warning"></span></a></li>';
    ...
    f(".search-input-close i").on("click", function() {
      ...
      e.hasClass("open") &&
        ...
        k.blur(),
        b.removeClass("show"),
        w.removeClass("show-overlay"));
    }),
    f(".search-list-main").length)
  )
    var o = new PerfectScrollbar(".search-list-main", { wheelPropagation: !1 });
  if (f(".search-list-bookmark").length)
  ...
  f(".search-list-main").mouseenter(function() {
    ...
    k.on("keyup", function(e) {
      if (
        (f(this)
          .closest(".search-list")
          .addClass("show"),
        38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode)
      ) {
        27 == e.keyCode &&
          (w.removeClass("show-overlay"),
          g.find("input").val(""),
          ...
          C.removeClass("open"),
          C.hasClass("show") &&
            (f(this).removeClass("show"), C.removeClass("show")));
        var n = f(this)
            .val()
            .toLowerCase(),
          i = "",
        ...
        if (
          ...
          f(this)
            .parent()
            .hasClass("bookmark-input") && (o = !0),
          "" != n)
        ) {
          w.addClass("show-overlay"),
            g.focus()
              ? y.addClass("show")
              : (b.addClass("show"), y.removeClass("show")),
            !1 === o && (b.addClass("show"), y.removeClass("show"));
          var l = "",
            r = "",
            c = "",
            d = "",
            h =
              '<li class=" d-flex align-items-center"><a href="#" class="pb-25"><h6 class="text-primary mb-0">Pages</h6></a></li>',
            m = "",
            u = "",
            p = 0;
          f.getJSON("../../../app-assets/data/" + v + ".json", function(e) {
            for (var a = 0; a < e.listItems.length; a++) {
              if (!0 === o) {
                i = "";
                for (
                  var t = f("ul.nav.navbar-nav.bookmark-icons li"), s = 0;
                  s < t.length;
                  s++
                ) {
                  if (
                    e.listItems[a].name ===
                    t[s].firstChild.dataset.originalTitle
                  ) {
                    i = " warning";
                    break;
                  }
              ...
              0 == e.listItems[a].name.toLowerCase().indexOf(n) &&
                p < 5 &&
                ((l +=
                  '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' +
                  (0 === p ? "current_item" : "") +
            ...
            for (a = 0; a < e.listItems.length; a++) {
              if (!0 === o) {
                i = "";
                for (
                  t = f("ul.nav.navbar-nav.bookmark-icons li"), s = 0;
                  s < t.length;
                  s++
                )
                  i =
              ...
              0 != e.listItems[a].name.toLowerCase().indexOf(n) &&
                -1 < e.listItems[a].name.toLowerCase().indexOf(n) &&
                p < 5 &&
                ((r +=
                  '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' +
                  (0 === p ? "current_item" : "") +
            ...
            (u = f(".main-search-list-defaultlist").html()),
              "" == l &&
                "" == r &&
                (r = f(".main-search-list-defaultlist-other-list").html()),
              (c = h.concat(l, r, u)),
              f("ul.search-list").html(c),
              (d = l.concat(r)),
              f("ul.search-list-bookmark").html(d);
          });
        } else if (!0 === o) {
          for (
            var a = f("ul.nav.navbar-nav.bookmark-iconss li"), t = "", s = 0;
            s < a.length;
            s++
          )
            0 === s ? "current_item" : "",
          ...
          w.hasClass("show-overlay") && w.removeClass("show-overlay"),
    ...
    f(r).on("click", ".bookmark-input .search-list .bookmark-icon", function(
      ...
      if ((e.stopPropagation(), f(this).hasClass("warning"))) {
        ...
        (s =
          ...
          f(this).parent()[0].href +
          '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' +
          f(this).parent()[0].innerText +
          '"><i class="ficon ' +
          f(this).parent()[0].firstChild.firstChild.dataset.icon +
          '"></i></a></li>'),
          f("ul.nav.bookmark-icons").append(s),
    ...
    f(i).on("keydown", function(e) {
      var a,
        t,
        s = f(".search-list li.current_item");
      if (
        (40 === e.keyCode
          ? ((a = s.next()),
            s.removeClass("current_item"),
            (s = a.addClass("current_item")))
          : 38 === e.keyCode &&
            ((t = s.prev()),
            s.removeClass("current_item"),
            (s = t.addClass("current_item"))),
        13 === e.keyCode && 0 < f(".search-list li.current_item").length)
      ) {
