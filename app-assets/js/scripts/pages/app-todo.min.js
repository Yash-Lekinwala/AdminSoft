$(function() {
  ...
  $(document).on("click", ".todo-application .todo-item-info i", function(o) {
    $(this)
      .parent(".todo-item-info")
      .toggleClass("success"),
      o.stopPropagation();
  }),
    $(document).on("click", ".todo-application .todo-item-favorite i", function(
      o
    ) {
      $(this)
        .parent(".todo-item-favorite")
        .toggleClass("warning"),
        o.stopPropagation();
    }),
    ...
    $(".add-todo-item").on("click", function(o) {
      ...
      var t = "",
        ...
        a = $(".new-todo-item-desc").val();
      $(".modal.show .todo-item-info").hasClass("success") && (t = " success"),
        $(".modal.show .todo-item-favorite").hasClass("warning") &&
          (e = " warning"),
        $(".modal .dropdown-menu input:checked").each(function() {
          s +=
        ...
        "" != i &&
          $(".todo-task-list-wrapper").append(
            '<li class="todo-item" style="animation-delay: 0s;"  data-toggle="modal" data-target="#editTaskModal"><div class="todo-title-wrapper d-flex justify-content-between mb-50"><div class="todo-title-area d-flex align-items-center"><div class="title-wrapper d-flex"><div class="vs-checkbox-con"><input type="checkbox" ><span class="vs-checkbox vs-checkbox-sm"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span></div><h6 class="todo-title mt-50 mx-50">' +
              i +
              ...
              e +
              '"><i class="feather icon-star"></i></a><a class="todo-item-delete"><i class="feather icon-trash"></i></a></div></div><p class="mb-0 todo-desc truncate">' +
              a +
              "</p></li>"
          ),
        $("#form-edit-todo .edit-todo-item-title").val(i),
        $("#form-edit-todo .edit-todo-item-desc").val(a),
        ...
        $("#form-edit-todo .edit-todo-item-favorite").hasClass("warning") &&
          $("#form-edit-todo .edit-todo-item-favorite").addClass("warning");
    }),
    $(document).on("click", ".todo-task-list-wrapper .todo-item", function(o) {
      (d = $(this).find(".todo-title")),
        (n = $(this).find(".todo-desc")),
        ...
        $(this)
          ...
          .each(function() {
            var o = $(this)
              ...
              .data("value");
            $(
              '#form-edit-todo .dropdown-menu input[data-value="' + o + '"]'
            ).prop("checked", !0);
          }),
        $("#form-edit-todo .edit-todo-item-title").val(t),
        $("#form-edit-todo .edit-todo-item-desc").val(e),
    ...
    $(".update-todo-item").on("click", function() {
      var o = $("#form-edit-todo .edit-todo-item-title").val(),
        t = $("#form-edit-todo .edit-todo-item-desc").val(),
      ...
      $(d).text(o),
        ...
        $(e)
          .parent(".todo-item-info")
          .hasClass("success") && l.addClass("success"),
        $(s)
          .parent(".todo-item-favorite")
          .hasClass("warning") && c.addClass("warning");
      var i = $("#form-edit-todo .dropdown-menu input:checked"),
        a = "";
      i.each(function() {
        a +=
          '<div class="chip mb-0"><div class="chip-body"><span class="chip-text" data-value="' +
