$(document).ready(function() {
  var e = "#7367F0",
    t = [e, "#28C76F", "#EA5455", "#FF9F43", "#00cfe8"],
    a = !1;
  ...
  var s = {
    ...
    legend: { offsetY: -10 },
    xaxis: { type: "datetime" },
    yaxis: { min: 0, tickAmount: 5, title: { text: "Points" }, opposite: a },
    tooltip: {
      shared: !0,
      intersect: !1,
      y: {
  ...
  var l = {
    ...
    series: [
      {
        name: "Product1",
        data: c(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 })
      },
      {
        name: "Product2",
        data: c(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 })
  ...
  var m = {
    ...
    responsive: [
      {
        breakpoint: 480,
        options: { chart: { width: 350 }, legend: { position: "bottom" } }
      }
    ]
  };
